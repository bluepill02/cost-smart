...
export const metadata: Metadata = {
  ...
  description: 'Calculate your total annual LPG subsidy and savings. Compare market price vs subsidized price for domestic cylinders.',
  alternates: {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="mb-8 text-center">
        ...
        <p className="text-xl text-slate-600 max-w-2xl mx-auto">Calculate your total annual LPG subsidy and savings. Compare market price vs subsidized price for domestic cylinders.</p>
      </div>
