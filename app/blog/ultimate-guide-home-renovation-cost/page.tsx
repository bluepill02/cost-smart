...
export const metadata: Metadata = {
  ...
  description: 'Everything you need to know about Home Renovation Cost estimation. Room-wise budgets, material cost formulas, and expert tips to avoid common overspending.',
