...
export const metadata: Metadata = {
  ...
  description: 'Everything you need to know about Loan EMI calculation. The reducing-balance formula, amortization examples, and expert tips for choosing optimal loan tenure.',
  alternates: {
  ...
  openGraph: {
    ...
    description: 'Everything you need to know about Loan EMI calculation. The reducing-balance formula, amortization examples, and expert tips for choosing optimal loan tenure.',
    type: 'article',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Ultimate Guide to Loan EMI Calculation | CostSmart' }],
  },
};
...
export default function Post() {
  return (
    <BlogLayout
      title="Ultimate Guide to Loan EMI Calculation"
      date="2025-01-21"
    ...
    >
      ...
      <p>Financial errors compound over time. A small miscalculation in Loan Emi logic can lead to significant discrepancies over 10 or 20 years. Our tool uses verified algorithms aligned with the latest FY 2024-25 financial regulations and RBI guidelines to ensure you get the right numbers every time.</p>
