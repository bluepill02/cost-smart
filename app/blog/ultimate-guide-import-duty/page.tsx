...
export const metadata: Metadata = {
  title: 'Ultimate Guide to Import Duty Calculation | CostSmart',
  description: 'Everything you need to know about Import Duty calculation. Customs tariff formulas, HS code examples, and expert tips for computing total landed cost of goods.',
  alternates: {
    canonical: '/blog/ultimate-guide-import-duty',
  },
  openGraph: {
    title: 'Ultimate Guide to Import Duty Calculation | CostSmart',
    description: 'Everything you need to know about Import Duty calculation. Customs tariff formulas, HS code examples, and expert tips for computing total landed cost of goods.',
    type: 'article',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Ultimate Guide to Import Duty Calculation | CostSmart' }],
  },
};
...
export default function Post() {
  return (
    <BlogLayout
      title="Ultimate Guide to Import Duty Calculation"
      date="2025-01-21"
    ...
    >
      ...
      <h2>Introduction</h2>
      <p>The <strong>Import Duty</strong> is an essential financial tool designed to help individuals and professionals make data-driven decisions. In today&apos;s complex economic landscape, accuracy is paramount. This guide will walk you through how to use our calculator to optimize your financial planning, whether you are managing personal wealth or business finances.</p>

      <h2>How to Use This Calculator</h2>
      <p>Using the Import Duty is straightforward, but understanding the inputs ensures precise results:</p>
      <ol>
      ...
      <p>Financial errors compound over time. A small miscalculation in Import Duty logic can lead to significant discrepancies over 10 or 20 years. Our tool uses verified algorithms aligned with the latest FY 2024-25 financial regulations and RBI guidelines to ensure you get the right numbers every time.</p>
