...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://cost-smart-five.vercel.app/blog/how-to-use-debt-payoff-calculator',
  },
};
...
export default function Post() {
  return (
    ...
    >
      <h2>Introduction</h2>
      <p>The <strong>Debt Payoff Calculator</strong> is a powerful tool designed to help you estimate Debt Free Date quickly and accurately. Whether you are a professional or just planning your personal finances, this tool simplifies complex calculations.</p>
      ...
      <ol>
        ...
        <li><strong>Review the results:</strong> The calculator instantly updates to show your estimated Debt Free Date.</li>
      ...
      <div className="bg-blue-50 p-6 rounded-lg my-8">
        ...
        <a href="/debt-payoff-calculator" className="inline-block bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors">
          Go to Calculator
        </a>
      </div>
    </BlogLayout>
