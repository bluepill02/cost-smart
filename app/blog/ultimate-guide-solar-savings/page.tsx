...
export default function Post() {
  return (
    <BlogLayout
      ...
      category="Education"
    >
      <h2>What is Solar Savings?</h2>
      <p>Understanding <strong>Solar Savings</strong> is essential for making informed financial decisions. It represents...</p>

      <h2>The Math Behind the Calculation</h2>
      <p>While our <a href="/solar-roi" className="text-blue-600 hover:underline">Solar ROI Calculator</a> handles the heavy lifting, it's good to know the formula:</p>
      <pre className="bg-slate-900 text-slate-100 p-4 rounded-lg overflow-x-auto">
        <code>
          Savings = Generation * Rate - Cost
        </code>
      </pre>

      <h2>Factors Affecting Solar Savings</h2>
      <ul>
      ...
      <div className="mt-8">
        ...
        <a href="/solar-roi" className="text-xl font-bold text-blue-600 hover:underline">
          &rarr; Open Solar ROI Calculator
        </a>
      </div>
