...
export const metadata: Metadata = {
    ...
    description: 'An emergency fund is your financial seatbelt. Learn why you need one before investing, how much to save, and the best places to park this money safely.',
    alternates: {
        canonical: '/blog/emergency-fund-importance',
    },
    openGraph: {
        title: 'Why You Need an Emergency Fund (Before Investing)',
        description: 'An emergency fund is your financial seatbelt. Learn why you need one before investing, how much to save, and the best places to park this money safely.',
