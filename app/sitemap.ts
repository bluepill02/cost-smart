...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  urls.push(
    ...
    {
      url: `${baseUrl}/recommended-tools`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${baseUrl}/tools/ai-advisor`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    {
      url: `${baseUrl}/tools/budget-analyzer`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
    ...
    {
      url: `${baseUrl}/global-salary-converter`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/neighborhood-explorer`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/solar-roi/analyze`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.8,
    },
